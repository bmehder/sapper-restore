...
<svelte:head>
  <meta
    name="description"
    content="There are many treatment options for wounds and Restore Medical Group will work with you to provide the best option for care."
  />
  <title>Restore Medical Group | Patients | Golden, CO</title>
