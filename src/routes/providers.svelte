...
<svelte:head>
  <meta
    name="description"
    content="Your patients look to you as their contact for help across the board. Consider us as a resource that you can confidently recommend to deal with chronic wounds."
  />
  <title>Restore Medical Group | Providers | Golden, CO</title>
